  ...
  if (window.addEventListener) {
    var r = (window.StyleFix = {
        ...
        (p.onreadystatechange = function() {
          ...
          (n = function() {
            ...
            if (
              t &&
              e.parentNode &&
              (!p.status || p.status < 400 || p.status > 600)
            ) {
              if (((t = r.fix(t, !0, e)), a)) {
                t = t.replace(/url\(\s*?((?:"|')?)(.+?)\1\s*?\)/gi, function(
                  e,
                  r,
                  t
                ) {
                  return /^([a-z]{3,10}:|#)/i.test(t)
                    ? e
                    : /^\/\//.test(t)
                    ? 'url("' + o + t + '")'
                    : /^\//.test(t)
      ...
      register: function(e, t) {
        (r.fixers = r.fixers || []).splice(
          void 0 === t ? r.fixers.length : t,
          0,
          e
        );
      },
    ...
    if (window.StyleFix && window.getComputedStyle) {
      var t = (window.PrefixFree = {
        prefixCSS: function(e, n) {
          var i = t.prefix;
          if (
            (t.functions.indexOf("linear-gradient") > -1 &&
              (e = e.replace(
          ...
          return (
            n &&
              ((e = r("selectors", "", "\\b", t.prefixSelector, e)),
              (e = r("atrules", "@", "\\b", "@" + i + "$1", e))),
      ...
      !(function() {
        ...
        "Ms" != t.Prefix ||
          ...
          "MsTransform" in i ||
          !("msTransform" in i) ||
          t.properties.push("transform", "transform-origin"),
          t.properties.sort();
      })(),
        (function() {
          function e(e, r) {
          ...
          r["repeating-linear-gradient"] = r["repeating-radial-gradient"] = r[
            "radial-gradient"
          ] = r["linear-gradient"];
          var n = {
            initial: "color",
